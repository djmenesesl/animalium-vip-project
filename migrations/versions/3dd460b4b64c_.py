...
Revision ID: 3dd460b4b64c
Revises: 
Create Date: 2022-11-06 19:08:33.845498
...
def upgrade():
    ...
    sa.Column('tipo_mascota', sa.String(length=250), nullable=True),
    sa.Column('cantidad_mascota', sa.String(length=250), nullable=True),
    ...
    sa.Column('fecha_inicial', sa.Date(), nullable=True),
